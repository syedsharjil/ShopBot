...
class AmazonBot(object):
    ...
    def get_product_price(self, url):
        ...
        price = ""
        try:
            price = wait.until(EC.visibility_of_element_located((By.XPATH, '//*[@id="priceblock_ourprice"]'))).text
        ...
        try:
            price = wait.until(EC.visibility_of_element_located((By.XPATH, '//*[@id="priceblock_dealprice"]'))).text
        except:
            pass
